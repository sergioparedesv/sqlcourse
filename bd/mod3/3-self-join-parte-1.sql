...
/*Colocas un alias en el Join
SELECCIONA  nombre y apellido de la tabla estudiantes, email tambien.
DE estudiantes
UNIR con tabla estudiantes con el alias de compañeros
*/
